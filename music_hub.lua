...
local function afficherPageMusique(genreName)
    ...
    for _, data in pairs(Playlist[genreName]) do
        ...
        Btn.MouseEnter:Connect(function()
            TweenService:Create(Btn, TweenInfo.new(0.12), {BackgroundColor3 = Color3.fromRGB(32, 32, 42), TextColor3 = ThemeColor}):Play()
        end)
...
for genreName, _ in pairs(Playlist) do
    ...
    NavBtn.Size = UDim2.new(1, -6, 0, 38)
    NavBtn.BackgroundColor3 = Color3.fromRGB(25, 25, 30)
    NavBtn.Text = genreName
    ...
    NavBtn.MouseEnter:Connect(function()
        if NavBtn ~= currentNavBtn then
            TweenService:Create(NavBtn, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(32, 32, 40)}):Play()
        end
    end)
    NavBtn.MouseLeave:Connect(function()
        if NavBtn ~= currentNavBtn then
            TweenService:Create(NavBtn, TweenInfo.new(0.12), {BackgroundColor3 = Color3.fromRGB(25, 25, 30)}):Play()
        end
    end)
    ...
    NavBtn.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(ActiveBar, TweenInfo.new(0.15), {Size = UDim2.new(0, 3, 0, 26)}):Play()
        TweenService:Create(ActiveBar, TweenInfo.new(0.15), {Position = UDim2.new(0, 0, 0.5, -13)}):Play()
    ...
    if not currentNavBtn then
        ...
        TweenService:Create(NavBtn, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(30, 30, 38)}):Play()
        ActiveBar.Visible = true
        ActiveBar.Size = UDim2.new(0, 3, 0, 26)
        ActiveBar.Position = UDim2.new(0, 0, 0.5, -13)
    end
end

-- Bouton Custom ID
local CustomBtn = Instance.new("TextButton")
CustomBtn.Parent = NavFrame
CustomBtn.Size = UDim2.new(1, -6, 0, 38)
CustomBtn.BackgroundColor3 = Color3.fromRGB(35, 25, 25)
CustomBtn.Text = "✍️ Custom ID"
...
CustomBtn.MouseEnter:Connect(function()
    TweenService:Create(CustomBtn, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(45, 32, 32)}):Play()
end)
CustomBtn.MouseLeave:Connect(function()
    TweenService:Create(CustomBtn, TweenInfo.new(0.12), {BackgroundColor3 = Color3.fromRGB(35, 25, 25)}):Play()
end)
...
ConfigBtn.Parent = NavFrame
ConfigBtn.Size = UDim2.new(1, -6, 0, 38)
ConfigBtn.BackgroundColor3 = Color3.fromRGB(25, 35, 30)
ConfigBtn.Text = "🎨 Palette UI"
...
ConfigBtn.MouseEnter:Connect(function()
    TweenService:Create(ConfigBtn, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(32, 45, 35)}):Play()
end)
ConfigBtn.MouseLeave:Connect(function()
    TweenService:Create(ConfigBtn, TweenInfo.new(0.12), {BackgroundColor3 = Color3.fromRGB(25, 35, 30)}):Play()
end)
